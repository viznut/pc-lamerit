...
{
//    fprintf(stderr,"stereo_mix_to_float\n");
...
{
//    fprintf(stderr,"float_to_stereo_mix\n");
    for (unsigned int i = 0; i < count; i++) {
        *out++ = (int) (*in1 * f2ic);
        *out++ = (int) (*in2 * f2ic);
        in1++;
...
{
//    fprintf(stderr,"mono_mix_to_float\n");
    for (unsigned int i = 0; i < count; i++) {
        *out++ = *src * i2fc;
        src++;
    }
...
{
//    fprintf(stderr,"float_to_mono_flix\n");
    for (unsigned int i = 0; i < count; i++) {
        *out++ = (int) (*in * f2ic);
        in++;
    }
